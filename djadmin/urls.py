...
urlpatterns = [
        ...
        url(r'^person/(?P<person_id>[a-z0-9-]+)/mergeperson$', views.mergePerson, name='mergePerson'),
        url(r'^person/(?P<person_id>[a-z0-9-]+)/viewpersonfacetrack$', views.viewPersonFacetrack, name='viewPersonFacetrack'),
        url(r'^person/(?P<person_id>[a-z0-9-]+)/viewsimilarperson$', views.viewSimilarPerson, name='viewSimilarPerson'),
